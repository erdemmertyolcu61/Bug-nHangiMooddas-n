...
MOOD_GENRE_WEIGHTS = {
    ...
    "kadraj-estetigi": {18: 1.0, 14: 0.9, 12: 0.8, 878: 0.7, 9648: 0.6, 36: 0.5, 10752: 0.5, 99: 0.4, 53: 0.3, 10749: 0.2, 16: 0.1, 28: 0.1, 80: 0.1, 10402: 0.1, 27: 0.0, 35: 0.0, 10751: 0.0, 37: 0.0, 10770: 0.0},
    ...
    for mood_id, weights in MOOD_GENRE_WEIGHTS.items():
        ...
        if mood_id == "zamanyolcusu" and year > 0:
            ...
            if year >= 2015:
                ...
                year_bonus = -0.05
        elif mood_id == "battaniye" and year > 0:
            # Cozy filmler her dönemden olabilir ama çok eski Yeşilçam dominasyonu engellenir
            if year >= 2010:
                year_bonus = 0.04
            elif year >= 2000:
                year_bonus = 0.02
                ...
                year_bonus = -0.06
        elif mood_id == "kahkaha" and year > 0:
            # Modern komediler genelde daha iyi yaşlanır; eski komediler kültürel bağlama bağımlı
            if year >= 2010:
                year_bonus = 0.05
            elif year >= 2000:
                year_bonus = 0.03
