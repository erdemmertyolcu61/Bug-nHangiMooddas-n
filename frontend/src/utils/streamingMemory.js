...
const PLATFORM_MAPPING = {
  ...
  1826: { name: 'TOD',            color: '#14E0A4', web: (t) => `https://www.todtv.com.tr/ara?q=${encodeURIComponent(t)}`, app: null, home: 'https://www.todtv.com.tr' },
  ...
  1904: { name: 'TV+',            color: '#FFC900', web: (t) => `https://tvplus.com.tr/arama?q=${encodeURIComponent(t)}`, app: null, home: 'https://www.tvplus.com.tr' },
  1833: { name: 'Tivibu',         color: '#00AEEF', web: (t) => `https://www.tivibu.com.tr/arama?q=${encodeURIComponent(t)}`, app: null, home: 'https://www.tivibu.com.tr' },
  ...
  1968: { name: 'Exxen',          color: '#00E5A0', web: (t) => `https://www.exxen.com/tr/arama/${encodeURIComponent(t)}`, app: null, home: 'https://www.exxen.com' },
};
 ...
 * web: null olan platformlarda TMDB fallback'ine değil, platformun
 * ana sayfasına yönlendirir (kullanıcı kendisi arar).
 */
export function buildWatchUrl(providerId, movieTitle, fallbackLink = null) {
  ...
  // 1. Platforma özel arama URL'i varsa → doğrudan filme ait arama sayfası
  if (title && info.web) return info.web(title);
  // 2. Arama URL'i yoksa → platformun ana sayfasına git (TMDB'ye değil!)
  return info.home;
}
